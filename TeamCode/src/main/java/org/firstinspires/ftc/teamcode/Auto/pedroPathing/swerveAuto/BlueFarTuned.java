...
public class BlueFarTuned extends OpMode {
    ...
    public void init() {
        ...
        // Define Poses
        p0 = new Pose(0, 9, 0);
        p1 = new Pose(0, -TARGET_TILE_INCHES*1.5, 0);//In front of row 1
        p2 = new Pose(30,-TARGET_TILE_INCHES*1.5 , 0); //Through row 1
        p3 = new Pose(0, -TARGET_TILE_INCHES*2.5, 0); //Front row 2
        p4 = new Pose(30, -TARGET_TILE_INCHES*2.5, 0);   //Through row 2
        p5 = new Pose(0, -TARGET_TILE_INCHES*3.5, 0); //Front row 3
        p6 = new Pose(30, -TARGET_TILE_INCHES*3.5, 0);//Through row 3
        ...
        switch (pathState) {
            ...
            case 5: // Waiting to finish Side 4
                if (!follower.isBusy()) {
                    ...
                    side6.setTimeoutConstraint(2000);
